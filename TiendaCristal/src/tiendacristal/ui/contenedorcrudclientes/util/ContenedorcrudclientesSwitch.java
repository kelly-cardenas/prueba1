 ...
 * @generated
 */
public class ContenedorcrudclientesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ContenedorcrudclientesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ContenedorcrudclientesPackage.CONTENEDOR_CRUD_CLIENTE_VIEW_MODEL: {
			...
			case ContenedorcrudclientesPackage.CONTENEDOR_DETALLE_CLIENTE_VIEW_MODEL: {
			...
			case ContenedorcrudclientesPackage.CONTENEDOR_MAESTRO_CLIENTE_VIEW_MODEL: {
			...
			case ContenedorcrudclientesPackage.CLIENTE_VIEW_MODEL: {
