...
/**
 * This is the item provider adapter for a {@link tiendacristal.ui.contenedorcrudclientes.ClienteViewModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClienteViewModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContenedorcrudclientesPackage.Literals.CLIENTE_VIEW_MODEL__NOMBRE,
				 true,
				 false,
				 false,
	...
	protected void addCodigoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClienteViewModel_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClienteViewModel_codigo_feature", "_UI_ClienteViewModel_type"),
				 ContenedorcrudclientesPackage.Literals.CLIENTE_VIEW_MODEL__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTipoClientePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ClienteViewModel_tipoCliente_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ClienteViewModel_tipoCliente_feature", "_UI_ClienteViewModel_type"),
				 ContenedorcrudclientesPackage.Literals.CLIENTE_VIEW_MODEL__TIPO_CLIENTE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((ClienteViewModel)object).getNombre();
